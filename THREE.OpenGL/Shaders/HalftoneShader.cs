...
public class HalftoneShader : ShaderMaterial
{
    public HalftoneShader()
    {
        ...
        Uniforms.Add("rotateR", new GLUniform { { "value", (float)Math.PI / 12 * 1 } });
        Uniforms.Add("rotateG", new GLUniform { { "value", (float)Math.PI / 12 * 2 } });
        Uniforms.Add("rotateB", new GLUniform { { "value", (float)Math.PI / 12 * 3 } });
