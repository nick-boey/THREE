...
public class GLUtils
{
    ...
    public All Convert(int p)
    {
        ...
        if (p == Constants.RGB_PVRTC_4BPPV1_Format || p == Constants.RGB_PVRTC_2BPPV1_Format ||
            ...
            if (Extensions.ExtensionsName.Contains(
                    "GL_ARB_compressed_texture_pvrtc")) // 'WEBGL_compressed_texture_pvrtc' 
            {
                if (p == Constants.RGB_PVRTC_4BPPV1_Format)
                    return All.CompressedRgbPvrtc4Bppv1Img; //extension.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
        ...
        if (p == Constants.RGBA_ASTC_4x4_Format || p == Constants.RGBA_ASTC_5x4_Format ||
            p == Constants.RGBA_ASTC_5x5_Format ||
            p == Constants.RGBA_ASTC_6x5_Format || p == Constants.RGBA_ASTC_6x6_Format ||
            p == Constants.RGBA_ASTC_8x5_Format ||
            p == Constants.RGBA_ASTC_8x6_Format || p == Constants.RGBA_ASTC_8x8_Format ||
            p == Constants.RGBA_ASTC_10x5_Format ||
            p == Constants.RGBA_ASTC_10x6_Format || p == Constants.RGBA_ASTC_10x8_Format ||
            p == Constants.RGBA_ASTC_10x10_Format ||
