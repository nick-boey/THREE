...
public class GLMaterials
{
    ...
    private void RefreshUniformsNormal(GLUniforms uniforms, MeshNormalMaterial material)
    {
        if (material.BumpMap != null)
        {
            ...
            {
                var value = (float)(uniforms["bumpScale"] as GLUniform)["value"];
        ...
        if (material.NormalMap != null)
        {
            ...
            if (material.Side == Constants.BackSide)
            {
                var value = (Vector2)(uniforms["normalScale"] as GLUniform)["value"];
    ...
    public void RefreshMaterialUniforms(GLUniforms m_uniforms, Material material, float pixelRatio, float height,
        GLRenderTarget transmissionRenderTarget)
    {
        ...
        else if (material is LineBasicMaterial)
        {
            ...
            if (material is LineDashedMaterial) RefreshUniformsDash(m_uniforms, (LineDashedMaterial)material);
        }
    ...
    {
        if (material.EmissiveMap != null) (uniforms["emissiveMap"] as GLUniform)["value"] = material.EmissiveMap;
    }
    ...
    private void RefreshUniformsToon(GLUniforms uniforms, MeshToonMaterial material)
    {
        ...
        if (material.GradientMap != null) (uniforms["gradientMap"] as GLUniform)["value"] = material.GradientMap;
    ...
    {
        (uniforms["specular"] as GLUniform)["value"] = material.Specular;
        (uniforms["shininess"] as GLUniform)["value"] =
            (float)Math.Max(material.Shininess, 1e-4); // to prevent pow( 0.0, 0.0 )
        ...
        GLRenderTarget transmissionRenderTarget)
    {
        ...
        if (material.ClearcoatMap != null) (uniforms["clearcoatMap"] as GLUniform)["value"] = material.ClearcoatMap;
        ...
        if (material.ClearcoatNormalMap != null)
        {
            ...
            if (material.Side == Constants.BackSide)
            {
                var value = (Vector2)(uniforms["clearcoatNormalScale"] as GLUniform)["value"];
        ...
        if (material.Transmission > 0.0f)
        {
            ...
            (uniforms["transmissionSamplerSize"] as GLUniform)["value"] =
                new Vector2(transmissionRenderTarget.Width, transmissionRenderTarget.Height);
        }

        (uniforms["thickness"] as GLUniform)["value"] = material.Thickness;
        if (material.ThicknessMap != null) (uniforms["thicknessMap"] as GLUniform)["value"] = material.ThicknessMap;
    ...
    private void RefreshUniformsStandard(GLUniforms uniforms, MeshStandardMaterial material)
    {
        ...
        if (material.RoughnessMap != null) (uniforms["roughnessMap"] as GLUniform)["value"] = material.RoughnessMap;

        if (material.MetalnessMap != null) (uniforms["metalnessMap"] as GLUniform)["value"] = material.MetalnessMap;
    ...
    {
        if (material.Matcap != null) (uniforms["matcap"] as GLUniform)["value"] = material.Matcap;
    ...
    private void RefreshUniformsCommon(GLUniforms uniforms, Material material)
    {
        ...
        if (material.Color != null) (uniforms["diffuse"] as GLUniform)["value"] = material.Color;
        ...
        if (material.Map != null) (uniforms["map"] as GLUniform)["value"] = material.Map;

        if (material.AlphaMap != null) (uniforms["alphaMap"] as GLUniform)["value"] = material.AlphaMap;

        if (material.SpecularMap != null) (uniforms["specularMap"] as GLUniform)["value"] = material.SpecularMap;
        ...
        if (envMap != null)
        {
            ...
            (uniforms["flipEnvMap"] as GLUniform)["value"] =
                envMap is CubeTexture && (envMap as CubeTexture).NeedsFlipEnvMap ? -1.0f : 1.0f;
            ...
            if (maxMipLevel != null) (uniforms["maxMipLevel"] as GLUniform)["value"] = maxMipLevel;
        }
        ...
        else if (material.ClearcoatRoughnessMap != null) uvScaleMap = material.ClearcoatRoughnessMap;

        if (uvScaleMap != null)
        {
            // backwards compatibility
            if (uvScaleMap is GLRenderTarget) uvScaleMap = (uvScaleMap as GLRenderTarget).Texture;

            if (uvScaleMap.MatrixAutoUpdate) uvScaleMap.UpdateMatrix();
        ...
        else if (material.LightMap != null) uv2ScaleMap = material.LightMap;

        if (uv2ScaleMap != null)
        {
            if (uv2ScaleMap is GLRenderTarget) uv2ScaleMap = (uv2ScaleMap as GLRenderTarget).Texture;
            if (uv2ScaleMap.MatrixAutoUpdate) uv2ScaleMap.UpdateMatrix();
    ...
    private void RefreshUniformsPoints(GLUniforms uniforms, PointsMaterial material, float _pixelRatio, float height)
    {
        ...
        if (material.Map != null)
            uvScaleMap = material.Map;
        else if (material.AlphaMap != null) uvScaleMap = material.AlphaMap;
