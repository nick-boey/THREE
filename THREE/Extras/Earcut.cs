...
public class Earcut
{
    ...
    public List<int> Triangulate(List<float> data, List<int> holeIndices, int? dim = null)
    {
        ...
        if (data.Count > 80 * dim)
        {
            ...
            for (var i = dim.Value; i < outerLen; i += dim.Value)
            {
                x = data[i];
                y = data[i + 1];
                if (x < minX) minX = x;
    ...
    public void EarcutLinked(EarcutNode ear, List<int> triangles, int dim, float minX, float minY, float invSize,
        int? pass = null)
    {
        if (ear == null) return;
    ...
    public EarcutNode EliminateHoles(List<float> data, List<int> holeIndices, EarcutNode outerEarcutNode, int dim)
    {
        ...
        queue.Sort(delegate(EarcutNode a, EarcutNode b) { return (int)(a.X - b.X); });
    ...
    public bool IsValidDiagonal(EarcutNode a, EarcutNode b)
    {
        return a.Next.I != b.I && a.Prev.I != b.I && !IntersectsPolygon(a, b) && // dones't intersect other edges
               ((LocallyInside(a, b) && LocallyInside(b, a) && MiddleInside(a, b) && // locally visible
                ...
                (EarcutNodeEquals(a, b) && Area(a.Prev, a, a.Next) > 0 &&
    ...
    public int zOrder(float _x, float _y, float minX, float minY, float invSize)
    {
        ...
        var x = Convert.ToInt32(32767 * (_x - minX) * invSize);
        var y = Convert.ToInt32(32767 * (_y - minY) * invSize);
