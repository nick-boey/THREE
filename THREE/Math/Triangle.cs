...
{
    private static Vector3 _v0 = new();
    private static Vector3 _v1 = new();
    private static Vector3 _v2 = new();
    private static Vector3 _v3 = new();

    private Vector3 _vab = new();
    private Vector3 _vac = new();
    private Vector3 _vap = new();
    private Vector3 _vbc = new();
    private Vector3 _vbp = new();
    private Vector3 _vcp = new();
    ...
    {
        a = _a != null ? a : new Vector3();
        b = _b != null ? b : new Vector3();
        c = _c != null ? c : new Vector3();
    }
    ...
    public static Vector3 GetNormal(Vector3 _a, Vector3 _b, Vector3 _c, Vector3 target)
    {
        ...
        if (targetLengthSq > 0) return target.MultiplyScalar(1 / (float)Math.Sqrt(targetLengthSq));
    ...
    {
        if (target == null) target = new Plane();
    ...
    {
        return IsFrontFacing(a, b, c, direction);
    }
