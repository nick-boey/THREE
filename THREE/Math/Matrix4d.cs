...
public class Matrix4d
{
    ...
    private Vector3d _x = new();

    private Vector3d _y = new();

    private Vector3d _z = new();
    ...
    public object Clone()
    {
        return new Matrix4d().FromArray(Elements);
    }
    ...
    public Matrix4d Invert()
    {
        ...
        double n11 = te[0],
            ...
            n34 = te[14],
            n44 = te[15],
            t11 = n23 * n34 * n42 - n24 * n33 * n42 + n24 * n32 * n43 - n22 * n34 * n43 - n23 * n32 * n44 +
                  n22 * n33 * n44,
            t12 = n14 * n33 * n42 - n13 * n34 * n42 - n14 * n32 * n43 + n12 * n34 * n43 + n13 * n32 * n44 -
                  n12 * n33 * n44,
            t13 = n13 * n24 * n42 - n14 * n23 * n42 + n14 * n22 * n43 - n12 * n24 * n43 - n13 * n22 * n44 +
                  n12 * n23 * n44,
            t14 = n14 * n23 * n32 - n13 * n24 * n32 - n14 * n22 * n33 + n12 * n24 * n33 + n13 * n22 * n34 -
                  n12 * n23 * n34;
    ...
    {
        var maxY = depthNear * Math.Tan(0.5f * fovy);
        var minY = -maxY;
    ...
    public Matrix4d FromArray(double[] array, int? offset = null)
    {
        ...
        for (var i = 0; i < 16; i++) Elements[i] = array[i + index];
