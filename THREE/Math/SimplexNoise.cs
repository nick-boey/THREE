...
public class SimplexNoise
{
    ...
    public SimplexNoise()
    {
        ...
        grad4 = new[]
        {
            new float[] { 0, 1, 1, 1 }, new float[] { 0, 1, 1, -1 }, new float[] { 0, 1, -1, 1 },
            new float[] { 0, 1, -1, -1 },
            new float[] { 0, -1, 1, 1 }, new float[] { 0, -1, 1, -1 }, new float[] { 0, -1, -1, 1 },
            new float[] { 0, -1, -1, -1 },
            new float[] { 1, 0, 1, 1 }, new float[] { 1, 0, 1, -1 }, new float[] { 1, 0, -1, 1 },
            new float[] { 1, 0, -1, -1 },
            new float[] { -1, 0, 1, 1 }, new float[] { -1, 0, 1, -1 }, new float[] { -1, 0, -1, 1 },
            new float[] { -1, 0, -1, -1 },
            new float[] { 1, 1, 0, 1 }, new float[] { 1, 1, 0, -1 }, new float[] { 1, -1, 0, 1 },
            new float[] { 1, -1, 0, -1 },
            new float[] { -1, 1, 0, 1 }, new float[] { -1, 1, 0, -1 }, new float[] { -1, -1, 0, 1 },
            new float[] { -1, -1, 0, -1 },
            new float[] { 1, 1, 1, 0 }, new float[] { 1, 1, -1, 0 }, new float[] { 1, -1, 1, 0 },
            new float[] { 1, -1, -1, 0 },
            new float[] { -1, 1, 1, 0 }, new float[] { -1, 1, -1, 0 }, new float[] { -1, -1, 1, 0 },
            new float[] { -1, -1, -1, 0 }
        };
        for (var i = 0; i < 256; i++) p[i] = (int)Math.Floor(MathUtils.random.NextDouble() * 256);
        ...
        simplex = new[]
        {
            new float[] { 0, 1, 2, 3 }, new float[] { 0, 1, 3, 2 }, new float[] { 0, 0, 0, 0 },
            new float[] { 0, 2, 3, 1 }, new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 },
            new float[] { 0, 0, 0, 0 }, new float[] { 1, 2, 3, 0 },
            new float[] { 0, 2, 1, 3 }, new float[] { 0, 0, 0, 0 }, new float[] { 0, 3, 1, 2 },
            new float[] { 0, 3, 2, 1 }, new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 },
            new float[] { 0, 0, 0, 0 }, new float[] { 1, 3, 2, 0 },
            new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 },
            new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 },
            new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 },
            new float[] { 1, 2, 0, 3 }, new float[] { 0, 0, 0, 0 }, new float[] { 1, 3, 0, 2 },
            new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 },
            new float[] { 2, 3, 0, 1 }, new float[] { 2, 3, 1, 0 },
            new float[] { 1, 0, 2, 3 }, new float[] { 1, 0, 3, 2 }, new float[] { 0, 0, 0, 0 },
            new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 }, new float[] { 2, 0, 3, 1 },
            new float[] { 0, 0, 0, 0 }, new float[] { 2, 1, 3, 0 },
            new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 },
            new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 },
            new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 },
            new float[] { 2, 0, 1, 3 }, new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 },
            new float[] { 0, 0, 0, 0 }, new float[] { 3, 0, 1, 2 }, new float[] { 3, 0, 2, 1 },
            new float[] { 0, 0, 0, 0 }, new float[] { 3, 1, 2, 0 },
            new float[] { 2, 1, 0, 3 }, new float[] { 0, 0, 0, 0 }, new float[] { 0, 0, 0, 0 },
            new float[] { 0, 0, 0, 0 }, new float[] { 3, 1, 0, 2 }, new float[] { 0, 0, 0, 0 },
            new float[] { 3, 2, 0, 1 }, new float[] { 3, 2, 1, 0 }
        };
    }
    ...
    public float Noise(float xin, float yin)
    {
        ...
        var F2 = 0.5f * (float)(Math.Sqrt(3.0) - 1.0);
        var s = (xin + yin) * F2; // Hairy factor for 2D
        var i = (int)Math.Floor(xin + s);
        var j = (int)Math.Floor(yin + s);
        var G2 = (float)(3.0f - Math.Sqrt(3.0f)) / 6.0f;
        var t = (i + j) * G2;
    ...
    public float Noise4d(float x, float y, float z, float w)
    {
        ...
        var F4 = (float)(Math.Sqrt(5.0f) - 1.0f) / 4.0f;
        var G4 = (5.0f - (float)Math.Sqrt(5.0f)) / 20.0f;
