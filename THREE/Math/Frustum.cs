...
public class Frustum : ICloneable
{
    ...
    public Plane[] Planes = new Plane[6] { new(), new(), new(), new(), new(), new() };
    ...
    {
        Planes[0] = p0 != null ? p0 : new Plane();
        Planes[1] = p1 != null ? p1 : new Plane();
        Planes[2] = p2 != null ? p2 : new Plane();
        Planes[3] = p3 != null ? p3 : new Plane();
        Planes[4] = p4 != null ? p4 : new Plane();
        Planes[5] = p5 != null ? p5 : new Plane();
    }

    protected Frustum(Frustum other)
    {
        var planes = Planes;
        for (var i = 0; i < 6; i++) planes[i] = (Plane)other.Planes[i].Clone();
    }
