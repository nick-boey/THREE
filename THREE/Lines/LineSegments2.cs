...
{
    private readonly Box3 _box = new();
    private readonly Vector4 _clipToWorldVector = new();
    private readonly Vector3 _closestPoint = new();
    private readonly Vector3 _end = new();
    private readonly Vector4 _end4 = new();
    private readonly Line3 _line = new();
    private readonly Matrix4 _mvMatrix = new();
    private readonly Sphere _sphere = new();

    private readonly Vector4 _ssOrigin = new();
    private readonly Vector3 _ssOrigin3 = new();
    private readonly Vector3 _start = new();

    private readonly Vector4 _start4 = new();
    ...
    public override void Raycast(Raycaster raycaster, List<Intersection> intersects)
    {
        ...
        var threshold = raycaster.parameters.Line2.ContainsKey("threshold")
            ? (float)raycaster.parameters.Line2["threshold"]
            : 0;
        ...
        if (raycaster.ray.IntersectsBox(_box) == false) return;
