...
public class UniformsLib : Dictionary<string, GLUniforms>
{
    ...
    {
        Add("common", Common());
        Add("specularmap", SpecularMap());
        Add("envmap", EnvMap());
        Add("aomap", AoMap());
        Add("lightmap", LightMap());
        Add("emissivemap", EmissiveMap());
        Add("bumpmap", BumpMap());
        Add("normalmap", NormalMap());
        Add("displacementmap", DisplacementMap());
        Add("roughnessmap", RoughnessMap());
        Add("metalnessmap", MetalnessMap());
        Add("gradientmap", GradientMap());
        Add("fog", Fog());
        Add("lights", Lights());
        Add("points", Points());
        Add("sprite", Sprite());
