...
public sealed class ShaderLib : Hashtable
{
    ...
    public Dictionary<string, string> ShaderChunkDictionary = new();

    public UniformsLib UniformsLib = new();
    ...
    public ShaderLib()
    {
        ...
        Add("basic", BasicShader());
        Add("lambert", LambertShader());
        Add("phong", PhongShader());
        Add("standard", StandardShader());
        Add("toon", ToonShader());
        Add("matcap", MatcapShader());
        Add("points", PointsShader());
        Add("dashed", DashedShader());
        Add("depth", DepthShader());
        Add("normal", NormalShader());
        Add("sprite", SpriteShader());
        Add("background", BackgroundShader());
        Add("cube", CubeShader());
        Add("equirect", EquirectShader());
        Add("distanceRGBA", DistanceRGBAShader());
        Add("shadow", ShadowShader());
        Add("physical", PhysicalShader());
    }
    ...
    private GLShader LambertShader()
    {
        ...
        shader.Uniforms = UniformsUtils.Merge(new List<GLUniforms>
        {
            ...
            UniformsLib["fog"],
            UniformsLib["lights"],
            new() { { "emissive", new GLUniform { { "value", Vector3.Zero() } } } }
        });
