...
public interface IGLRenderer
{
    ...
    void RenderBufferDirect(Camera camera, Object3D scene, Geometry geometry, Material material, Object3D object3D,
        DrawRange? group);

    void ReadRenderTargetPixels(GLRenderTarget renderTarget, float x, float y, int width, int height, byte[] buffer,
        int? activeCubeFaceIndex);
