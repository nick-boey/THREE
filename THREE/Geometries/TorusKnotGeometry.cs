...
public class TorusKnotGeometry : Geometry
{
    ...
    public TorusKnotGeometry(float? radius = null, float? tube = null, float? tubularSegments = null,
        float? radialSegments = null, float? p = null, float? q = null)
    {
...
public class TorusKnotBufferGeometry : BufferGeometry
{
    ...
    public TorusKnotBufferGeometry(float? radius = null, float? tube = null, float? tubularSegments = null,
        float? radialSegments = null, float? p = null, float? q = null)
    {
        ...
        for (i = 0; i <= tubularSegments; ++i)
        {
            ...
            var u = i / (float)tubularSegments * (float)p * (float)Math.PI * 2;
