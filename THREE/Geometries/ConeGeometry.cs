...
{
    public ConeGeometry(float radius, float height, int? radialSegments = null, int? heightSegments = null,
        bool? openEnded = null, float? thetaStart = null, float? thetaLength = null) :
...
{
    public ConeBufferGeometry(float radius, float height, int? radialSegments = null, int? heightSegments = null,
        bool? openEnded = null, float? thetaStart = null, float? thetaLength = null) :
        base(0, radius, height, radialSegments, heightSegments, openEnded, thetaStart, thetaLength)
    {
    }
