...
{
    private float aperture = 0.0002f;
    private MeshStandardMaterial boxMaterial1;
    private MeshStandardMaterial boxMaterial2;

    private float focus = 10.0f;
    ...
    public override void Init()
    {
        ...
        AddGuiControlsAction = () => { AddShaderControls("bokeh", bokehPass); };
    }
