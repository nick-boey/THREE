...
public class MaterialExampleTemplate : Example
{
    ...
    private int wireframeLinecapIndex;

    private int wireframeLinejoinIndex;
    ...
    {
        var color = new System.Numerics.Vector3(material.Color.Value.R, material.Color.Value.G, material.Color.Value.B);
        if (ImGui.ColorPicker3("color", ref color)) material.Color = new Color(color.X, color.Y, color.Z);
    }
    ...
    public virtual void AddSpecificMaterialSettings(Material material, string name)
    {
        ...
        var emissiveColor = material.Emissive;
