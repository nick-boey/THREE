...
{
    private readonly int length = 160;
    private readonly Vector2 mouse = new();
    private readonly float pointSize = 0.05f;
    private readonly Raycaster raycaster = new();
    private readonly Matrix4 rotateY = new Matrix4().MakeRotationY(0.005f);
    private readonly List<Object3D> spheres = new();
    private readonly float threshold = 0.1f;
    private readonly int width = 80;
    private Intersection intersection;
    private List<Object3D> pointclouds;
    ...
    private BufferGeometry GeneratePointCloudGeometry(Color color, int w, int l)
    {
        ...
        var positions = new float[numPoints * 3];
        var colors = new float[numPoints * 3];
    ...
    public override void Init()
    {
        ...
        MouseMove += RaycastingPointsExample_MouseMove;
    }

    private void RaycastingPointsExample_MouseMove(object sender, MouseEventArgs e)
    {
