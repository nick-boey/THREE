...
public class ClippingExample : Example
{
    private bool globalPlaneEnabled;
    private List<Plane> globalPlanes, Empty;
    private Plane localPlane, globalPlane;
    private MeshPhongMaterial material;
    private Mesh object3d;
    private OrbitControls ocontrol;
    ...
    {
        ocontrol = new OrbitControls(this, camera);
    ...
    private void ShowControls()
    {
        ...
        {
            if (ImGui.Checkbox("Enabled", ref renderer.LocalClippingEnabled)) material.NeedsUpdate = true;
            if (ImGui.Checkbox("Shadows", ref material.ClipShadows)) material.NeedsUpdate = true;
