...
{
    private readonly Vector2 resulution = new();
    private float angleThreshold;
    private Material m;
    private OutlineMaterial mat;
    private float opacity;
    private Mesh pm, cm, tm;
    private OutlineMesh po, co, to;
    ...
    private void CreateObjects()
    {
        ...
        mat = new OutlineMaterial(60, true, Color.Hex(0x000));
