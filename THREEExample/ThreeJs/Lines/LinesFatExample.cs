...
{
    private bool alphaToCoverage = true;
    private Camera camera2;
    private bool dashed;
    private int dashGap = 1;
    private float dashScale = 1;
    private int insetWidth, insetHeight;
    private LineSegments2 line;
    private Line line1;
    private int lineType;
    private float lineWidth;
    private Material matLine, matLineBasic, matLineDashed;
    ...
    public override void InitCamera()
    {
        ...
        camera2 = new PerspectiveCamera(50, 1, 1, 1000);
    ...
    private void CreateObjects()
    {
        ...
        var points = GeometryUtils.Hilbert3D(new Vector3(0, 0, 0), 20);
        ...
        matLineBasic = new LineBasicMaterial { Color = Color.Hex(0xffffff), VertexColors = true };
    ...
    {
        var mat = matLine as LineMaterial;
