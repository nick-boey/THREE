...
public class MapControlsExample : Example
{
    ...
    {
        base.InitLighting();
        var dirLight1 = new DirectionalLight(0xffffff, 3);
        dirLight1.Position.Set(1, 1, 1);
        scene.Add(dirLight1);

        var dirLight2 = new DirectionalLight(0x002288, 3);
    ...
    {
        scene.Background = Color.Hex(0xcccccc);
        scene.Fog = new Fog(0xcccccc, 0.002f);
        var geometry = new BoxBufferGeometry();
        geometry.Translate(0, 0.5f, 0);
        var material = new MeshPhongMaterial { Color = Color.Hex(0xeeeeee), FlatShading = true };
    ...
    public override void Init()
    {
        ...
        AddGuiControlsAction = () => { ImGui.Checkbox("screenSpacePanning", ref mapControls.ScreenSpacePanning); };
    }
