...
public class STLLoaderSample : Example
{
    ...
    {
        var plane = new Mesh(new PlaneBufferGeometry(40, 40),
        ...
        var material1 = new MeshPhongMaterial
            { Color = Color.Hex(0xff5533), Specular = Color.Hex(0x111111), Shininess = 200 };
        ...
        var material2 = new MeshPhongMaterial
            { Color = Color.Hex(0xAAAAAA), Specular = Color.Hex(0x111111), Shininess = 200 };
