...
public class LightprobeCubeCamera : Example
{
    ...
    public override void Init()
    {
        ...
        {
            Encoding = Constants
                .sRGBEncoding, // since gamma is applied during rendering, the cubeCamera renderTarget texture encoding must be sRGBEncoding
