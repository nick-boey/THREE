...
public class WireframeGeometryExample : Example
{
    ...
    private void CreateGeometry()
    {
        ...
        lineSegments = new LineSegments(new WireframeGeometry(geom), lineMaterial);
    ...
    public override void Init()
    {
        ...
        var models = new[] { "Icosahedron", "Cylinder", "Teapot", "TorusKnot" };
        AddGuiControlsAction = () =>
        {
            if (ImGui.Combo("model", ref currentModel, models, 4)) UpdateGeometry(models[currentModel]);
