...
{
    private readonly int frustumSize = 600;
    private Camera activeCamera;
    private CameraHelper activeHelper, cameraPerspectiveHelper, cameraOrthoHelper;
    ...
    {
        camera.Fov = 50.0f;
        camera.Aspect = glControl.AspectRatio * 0.5f;
        camera.Near = 1f;
        camera.Far = 10000.0f;
        ...
        cameraOrtho = new OrthographicCamera(0.5f * frustumSize * glControl.AspectRatio / -2,
            0.5f * frustumSize * glControl.AspectRatio / 2, frustumSize / 2, frustumSize / -2, 150, 1000);
