...
public class NameEntry : TableEntry
{
    ...
    /// <summary>
    ///     PostScript name for the font; Name ID 6 specifies a string which is used to invoke a PostScript language font that
    ///     corresponds to this OpenType font.
    ///     When translated to ASCII, the name string must be no longer than 63 characters and restricted to the printable
    ///     ASCII subset,
    ///     codes 33 to 126, except for the 10 characters '[', ']', '(', ')', '{', '}', '&lt;', '&gt;', '/', '%'.
    ///     In a CFF OpenType font, there is no requirement that this name be the same as the font name in the CFF’s Name
    ///     INDEX.Thus,
