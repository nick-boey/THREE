...
internal class PostTable : TableEntry
{
    ...
    internal Dictionary<ushort, string> GlyphNames { get; private set; }
            ...
            case 0x00020000: //version 2
            {
                ...
                for (ushort i = 0; i < numOfGlyphs; ++i)
                {
                    ...
                    if (glyphNameIndex < 258)
                    {
                        ...
                        //replace? 
                        GlyphNames[i] = stdMacGlyphNames[glyphNameIndex];
                    }
                    else
                    {
                        ...
                        GlyphNames.Add(i, Encoding.UTF8.GetString(reader.ReadBytes(len), 0, len));
                    }
                }
            }
                break;
    ...
    {
        if (GlyphNames == null) return 0; //not found!
        //
