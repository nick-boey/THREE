...
internal class Kern : TableEntry
{
    ...
    private readonly List<KerningSubTable> _kernSubTables = new();
    ...
    protected override void ReadContentFrom(BinaryReader reader)
    {
        ...
        //TODO: review here
        if (nTables > 1) Utils.WarnUnimplemented("Support for {0} kerning tables", nTables);
        ...
        for (var i = 0; i < nTables; ++i)
        {
            ...
            var kerCoverage =
                new KernCoverage(reader.ReadUInt16()); //What type of information is contained in this table.
    ...
    private readonly struct KerningPair
    {
        ...
        /// <summary>
        ///     n FUnits. If this value is greater than zero, the characters will be moved apart. If this value is less than zero,
    ...
    {
        private readonly Dictionary<uint, short> _kernDic;
        private readonly List<KerningPair> _kernPairs;
        ...
        public short GetKernDistance(ushort left, ushort right)
        {
            ...
            _kernDic.TryGetValue(key, out var found);
            return found;
        }
    }
}