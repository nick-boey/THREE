...
internal class Meta : TableEntry
{
    ...
    protected override void ReadContentFrom(BinaryReader reader)
    {
        ...
        var tableStartsAt = reader.BaseStream.Position; //***
...
#if DEBUG
        if (version != 1 || flags != 0) throw new NotSupportedException();
#endif
    ...
    {
        var tags = Encoding.UTF8.GetString(data).Split(',');
