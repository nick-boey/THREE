...
public class JSTF : TableEntry
{
    ...
    protected override void ReadContentFrom(BinaryReader reader)
    {
        ...
        var jstfScriptCount = reader.ReadUInt16();
    ...
    private static JstfScriptTable ReadJstfScriptTable(BinaryReader reader)
    {
        ...
        var extenderGlyphOffset = reader.ReadUInt16();
        var defJstfLangSysOffset = reader.ReadUInt16();
        var jstfLangSysCount = reader.ReadUInt16();

        if (jstfLangSysCount > 0)
        {
            var recs = new JstfLangSysRecord[jstfLangSysCount];
            for (var i = 0; i < jstfLangSysCount; ++i) recs[i] = ReadJstfLangSysRecord(reader);
    ...
    private static JstfLangSysRecord ReadJstfLangSysRecord(BinaryReader reader)
    {
        ...
        var tableStartAt = reader.BaseStream.Position;
        var jstfPriorityCount = reader.ReadUInt16();
        var jstfPriorityOffsets = reader.ReadUInt16Array(jstfPriorityCount);
    ...
    private readonly struct JstfScriptRecord
    {
