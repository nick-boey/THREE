...
public partial class GSUB : GlyphShapingTableEntry
{
    ...
    public class LookupTable
    {
        ...
        public void CollectAssociatedSubstitutionGlyph(List<ushort> outputAssocGlyphs)
        {
            ...
            //                
            //so, we collect it here, based on current script lang.
            foreach (var subTable in SubTables) subTable.CollectAssociatedSubtitutionGlyphs(outputAssocGlyphs);
        }
        ...
        private static LookupSubTable ReadLookupType1(BinaryReader reader, long subTableStartAt)
        {
            ...
            switch (format)
            {
                ...
                case 1:
                {
                    var deltaGlyph = reader.ReadUInt16();
        ...
        private static LookupSubTable ReadLookupType2(BinaryReader reader, long subTableStartAt)
        {
            ...
            switch (format)
            {
                ...
                case 1:
                {
                    ...
                    var seqOffsets = reader.ReadUInt16Array(seqCount);
        ...
        private static LookupSubTable ReadLookupType3(BinaryReader reader, long subTableStartAt)
        {
            ...
            switch (format)
            {
                ...
                case 1:
                {
                    ...
                    var alternativeTableOffsets = reader.ReadUInt16Array(alternativeSetCount);
                    ...
                    for (var n = 0; n < alternativeSetCount; ++n)
                        alternativeSetTables[n] =
                            AlternativeSetTable.CreateFrom(reader, subTableStartAt + alternativeTableOffsets[n]);
                    subTable.CoverageTable = CoverageTable.CreateFrom(reader, subTableStartAt + coverageOffset);
        ...
        private static LookupSubTable ReadLookupType4(BinaryReader reader, long subTableStartAt)
        {
            ...
            switch (format)
            {
                ...
                case 1:
                {
                    ...
                    var ligSetOffsets = reader.ReadUInt16Array(ligSetCount);
        ...
        private static LookupSubTable ReadLookupType5(BinaryReader reader, long subTableStartAt)
        {
            ...
            switch (substFormat)
            {
                ...
                case 1:
                {
                    ...
                    var coverageOffset = reader.ReadUInt16();
                    var subRuleSetCount = reader.ReadUInt16();
                    var subRuleSetOffsets = reader.ReadUInt16Array(subRuleSetCount);
                    ...
                    for (var i = 0; i < subRuleSetCount; ++i)
                        fmt1.subRuleSets[i] =
                            LkSubT5Fmt1_SubRuleSet.CreateFrom(reader, subTableStartAt + subRuleSetOffsets[i]);
                ...
                case 2:
                {
                    ...
                    var subClassSetCount = reader.ReadUInt16();
                    var subClassSetOffsets = reader.ReadUInt16Array(subClassSetCount);
                    //
                    ...
                    for (var i = 0; i < subClassSetCount; ++i)
                        subClassSets[i] =
                            LkSubT5Fmt2_SubClassSet.CreateFrom(reader, subTableStartAt + subClassSetOffsets[i]);
        ...
        private static LookupSubTable ReadLookupType6(BinaryReader reader, long subTableStartAt)
        {
            ...
            switch (format)
            {
                ...
                case 1:
                {
                    ...
                    var chainSubRulesetOffsets = reader.ReadUInt16Array(chainSubRulesetCount);
                    var subRuleSets = subTable.SubRuleSets = new ChainSubRuleSetTable[chainSubRulesetCount];
                    for (var n = 0; n < chainSubRulesetCount; ++n)
                        subRuleSets[n] =
                            ChainSubRuleSetTable.CreateFrom(reader, subTableStartAt + chainSubRulesetOffsets[n]);
                    //----------------------------
                ...
                case 2:
                {
                    ...
                    var chainSubClassSetOffsets = reader.ReadUInt16Array(chainSubClassSetCount);
                    //
                    ...
                    subTable.LookaheadClassDef =
                        ClassDefTable.CreateFrom(reader, subTableStartAt + lookaheadClassDefOffset);
                    if (chainSubClassSetCount != 0)
                    {
                        var chainSubClassSets =
                            subTable.ChainSubClassSets = new ChainSubClassSet[chainSubClassSetCount];
                        for (var n = 0; n < chainSubClassSetCount; ++n)
                        {
                            var offset = chainSubClassSetOffsets[n];
                            if (offset > 0)
                ...
                case 3:
                {
                    ...
                    var backtrackingCoverageOffsets = reader.ReadUInt16Array(backtrackingGlyphCount);
                    ...
                    subTable.BacktrackingCoverages =
                        CoverageTable.CreateMultipleCoverageTables(subTableStartAt, backtrackingCoverageOffsets,
                            reader);
                    subTable.InputCoverages =
        ...
        private static LookupSubTable ReadLookupType7(BinaryReader reader, long subTableStartAt)
        {
            ...
            if (extensionLookupType == 7) throw new NotSupportedException();
        ...
        private class LkSubTableT1Fmt2 : LookupSubTable
        {
            ...
            /// <summary>
            ///     It provides an array of output glyph indices (Substitute) explicitly matched to the input glyph indices specified
        ...
        private readonly struct SequenceTable
        {
        ...
        private class LkSubTableT3 : LookupSubTable
        {
            ...
            public override bool DoSubstitutionAt(IGlyphIndexList glyphIndices, int pos, int len)
            {
                ...
                var iscovered = CoverageTable.FindPosition(glyphIndices[pos]);
        ...
        private class LkSubTableT4 : LookupSubTable
        {
            ...
            public override void CollectAssociatedSubtitutionGlyphs(List<ushort> outputAssocGlyphs)
            {
                foreach (var glyphIndex in CoverageTable.GetExpandedValueIter())
                {
                    var foundPos = CoverageTable.FindPosition(glyphIndex);
                    var ligTable = LigatureSetTables[foundPos];
                    foreach (var lig in ligTable.Ligatures) outputAssocGlyphs.Add(lig.GlyphId);
                }
            }
        }
        ...
        private class LigatureSetTable
        {
            ...
            public static LigatureSetTable CreateFrom(BinaryReader reader, long beginAt)
            {
                ...
                var ligOffsets = reader.ReadUInt16Array(ligCount);
                //
        ...
        private readonly struct LigatureTable
        {
            //uint16 	LigGlyph 	GlyphID of ligature to substitute
            //uint16 	CompCount 	Number of components in the ligature
            //uint16 	Component[CompCount - 1] 	Array of component GlyphIDs-start with the second component-ordered in writing direction
        ...
        /// </summary>
        private class LkSubTableT5Fmt1 : LookupSubTable
        {
            ...
            public override bool DoSubstitutionAt(IGlyphIndexList glyphIndices, int pos, int len)
            {
                var coverage_pos = coverageTable.FindPosition(glyphIndices[pos]);
        ...
        private class LkSubT5Fmt1_SubRuleSet
        {
            ...
            public static LkSubT5Fmt1_SubRuleSet CreateFrom(BinaryReader reader, long beginAt)
            {
                ...
                var subRuleOffsets = reader.ReadUInt16Array(subRuleCount);
        ...
        private class LkSubT5Fmt1_SubRule
        {
            ...
            public void ReadFrom(BinaryReader reader, long pos)
            {
                ...
                var glyphCount = reader.ReadUInt16();
                var substitutionCount = reader.ReadUInt16();
        ...
        /// </summary>
        private class LkSubTableT5Fmt2 : LookupSubTable
        {
            ...
            public override void CollectAssociatedSubtitutionGlyphs(List<ushort> outputAssocGlyphs)
            {
                ...
                foreach (var glyphIndex in coverageTable.GetExpandedValueIter())
                {
                    var class_value = classDef.GetClassValue(glyphIndex);
                    if (collected.ContainsKey(class_value)) continue;
                    //
                    collected.Add(class_value, true);

                    var subClassSet = subClassSets[class_value];
                    var subClassRules = subClassSet.subClassRules;

                    for (var i = 0; i < subClassRules.Length; ++i)
                    {
                        var rule = subClassRules[i];
                        if (rule != null && rule.substRecords != null)
                            for (var n = 0; n < rule.substRecords.Length; ++n)
                            {
                                var rect = rule.substRecords[n];
                                var anotherLookup = OwnerGSub.LookupList[rect.lookupListIndex];
            ...
            public override bool DoSubstitutionAt(IGlyphIndexList glyphIndices, int pos, int len)
            {
                ...
                var class_value = classDef.GetClassValue(glyphIndices[pos]);
                ...
                {
                    var rule = subClassRules[i];
                    var inputSequence = rule.inputSequence; //clas seq
                    var next_pos = pos + 1;
        ...
        private class LkSubT5Fmt2_SubClassSet
        {
            ...
            public static LkSubT5Fmt2_SubClassSet CreateFrom(BinaryReader reader, long beginAt)
            {
                ...
                var subClassRuleCount = reader.ReadUInt16();
                var subClassRuleOffsets = reader.ReadUInt16Array(subClassRuleCount);
        ...
        private class LkSubT5Fmt2_SubClassRule
        {
        ...
        /// </summary>
        private class LkSubTableT5Fmt3 : LookupSubTable
        {
            public override void CollectAssociatedSubtitutionGlyphs(List<ushort> outputAssocGlyphs)
            {
                throw new NotImplementedException();
        ...
        private class ChainSubRuleSetTable
        {
            ...
            public static ChainSubRuleSetTable CreateFrom(BinaryReader reader, long beginAt)
            {
                ...
                var subRuleCount = reader.ReadUInt16();
                var subRuleOffsets = reader.ReadUInt16Array(subRuleCount);
                var chainSubRuleSubTables = table._chainSubRuleSubTables = new ChainSubRuleSubTable[subRuleCount];
                for (var i = 0; i < subRuleCount; ++i)
        ...
        private readonly struct SubstLookupRecord
        {
        ...
        private class ChainSubRuleSubTable
        {
            ...
            public static ChainSubRuleSubTable CreateFrom(BinaryReader reader, long beginAt)
            {
                ...
                //--------
                var inputGlyphCount = reader.ReadUInt16();
                subRuleTable.inputGlyphs =
                    reader.ReadUInt16Array(inputGlyphCount - 1); //*** start with second glyph, so -1
                //----------
                var lookaheadGlyphCount = reader.ReadUInt16();
        ...
        private class ChainSubClassSet
        {
            ...
            public static ChainSubClassSet CreateFrom(BinaryReader reader, long beginAt)
            {
                ...
                var subClassRuleOffsets = reader.ReadUInt16Array(count);
        ...
        private class LkSubTableT6Fmt2 : LookupSubTable
        {
            ...
            public override bool DoSubstitutionAt(IGlyphIndexList glyphIndices, int pos, int len)
            {
                ...
                var inputClass = InputClassDef.GetClassValue(glyphIndices[pos]);
