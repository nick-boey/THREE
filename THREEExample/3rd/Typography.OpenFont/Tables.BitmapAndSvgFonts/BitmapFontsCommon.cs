...
internal struct SbitLineMetrics
{
...
internal class BitmapSizeTable
{
...
internal readonly struct IndexSubTableArray
{
...
internal readonly struct IndexSubHeader
{
...
internal abstract class IndexSubTableBase
{
    ...
    public static IndexSubTableBase CreateFrom(BitmapSizeTable bmpSizeTable, BinaryReader reader)
    {
        ...
        switch (header.indexFormat)
        {
            ...
            {
                var nElem = bmpSizeTable.endGlyphIndex - bmpSizeTable.startGlyphIndex + 1;
                var offsetArray = reader.ReadUInt32Array(nElem);
                ...
                //GlyphIdOffsetPair   glyphArray[numGlyphs + 1]   One per glyph.
            {
                ...
                var numGlyphs = reader.ReadUInt32();
...
///     IndexSubTable1: variable - metrics glyphs with 4 - byte offsets
/// </summary>
internal class IndexSubTable1 : IndexSubTableBase
{
...
///     IndexSubTable2: all glyphs have identical metrics
/// </summary>
internal class IndexSubTable2 : IndexSubTableBase
{
    ...
    public override void BuildGlyphList(List<Glyph> glyphList)
    {
        ...
        for (var n = firstGlyphIndex; n <= lastGlyphIndex; ++n)
        {
...
///     IndexSubTable3: variable - metrics glyphs with 2 - byte offsets
/// </summary>
internal class IndexSubTable3 : IndexSubTableBase
{
...
///     IndexSubTable4: variable - metrics glyphs with sparse glyph codes
/// </summary>
internal class IndexSubTable4 : IndexSubTableBase
{
...
///     IndexSubTable5: constant - metrics glyphs with sparse glyph codes
/// </summary>
internal class IndexSubTable5 : IndexSubTableBase
{
    public BigGlyphMetrics BigGlyphMetrics;
    ...
    public override void BuildGlyphList(List<Glyph> glyphList)
    {
        ...
        {
            glyphList.Add(new Glyph(glyphIdArray[i], header.imageDataOffset + incrementalOffset, imageSize,
                header.imageFormat));
            incrementalOffset += imageSize;
        }
    }
...
internal readonly struct GlyphIdOffsetPair
{
...
internal struct BigGlyphMetrics
{
    public byte height;
    public byte width;
...
//int8    bearingY
//uint8   advance
internal struct SmallGlyphMetrics
{
    public byte height;
    public byte width;
...
internal abstract class GlyphBitmapDataFormatBase
{
...
/// </summary>
internal class GlyphBitmapDataFmt1 : GlyphBitmapDataFormatBase
{
...
/// </summary>
internal class GlyphBitmapDataFmt2 : GlyphBitmapDataFormatBase
{
...
internal class GlyphBitmapDataFmt5 : GlyphBitmapDataFormatBase
{
...
/// </summary>
internal class GlyphBitmapDataFmt6 : GlyphBitmapDataFormatBase
{
...
/// </summary>
internal class GlyphBitmapDataFmt7 : GlyphBitmapDataFormatBase
{
    public BigGlyphMetrics bigMetrics;
...
/// </summary>
internal class GlyphBitmapDataFmt8 : GlyphBitmapDataFormatBase
{
...
///     Format 9:
/// </summary>
internal class GlyphBitmapDataFmt9 : GlyphBitmapDataFormatBase
{
    public BigGlyphMetrics bigMetrics;
    public EbdtComponent[] components;
...
/// </summary>
internal class GlyphBitmapDataFmt17 : GlyphBitmapDataFormatBase
{
    ...
    public override void FillGlyphInfo(BinaryReader reader, Glyph bitmapGlyph)
    {
        SmallGlyphMetrics.ReadSmallGlyphMetric(reader, out var smallGlyphMetric);
    ...
    public override void ReadRawBitmap(BinaryReader reader, Glyph bitmapGlyph, Stream outputStream)
    {
        ...
        var rawPngData = reader.ReadBytes((int)dataLen);
...
/// </summary>
internal class GlyphBitmapDataFmt18 : GlyphBitmapDataFormatBase
{
    //Format 18: big metrics, PNG image data
    //Type              Name            Description
...
internal class GlyphBitmapDataFmt19 : GlyphBitmapDataFormatBase
{
