...
internal class CBDT : TableEntry, IDisposable
{
    ...
    private readonly GlyphBitmapDataFmt17 _format17 = new();
    private readonly GlyphBitmapDataFmt18 _format18 = new();
    private readonly GlyphBitmapDataFmt19 _format19 = new();
    ...
    protected override void ReadContentFrom(BinaryReader reader)
    {
        ...
        //-------------------
        var data = reader.ReadBytes((int)Header.Length); //***
