...
public class HalfEdge
{
...
#endif
    internal Face rightFace
    {
        get => _otherHalfOfThisEdge._leftFace;
        set => _otherHalfOfThisEdge._leftFace = value;
    }

    internal HalfEdge Lprev
    {
        get => _nextEdgeCCWAroundOrigin._otherHalfOfThisEdge;
        set => _nextEdgeCCWAroundOrigin._otherHalfOfThisEdge = value;
    }

    internal HalfEdge Oprev => _otherHalfOfThisEdge._nextEdgeCCWAroundLeftFace;

    internal ContourVertex DirectionVertex
    {
        get => _otherHalfOfThisEdge._originVertex;
        set => _otherHalfOfThisEdge._originVertex = value;
    }
    ...
    {
        return DirectionVertex.VertLeq(_originVertex);
    }

    internal bool EdgeGoesRight()
    {
        return _originVertex.VertLeq(DirectionVertex);
    }
}